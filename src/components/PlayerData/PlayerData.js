...
export default (props) => {
	...
	return (
		<div className={classNames(styles.playerData, styles[side], {[styles.turn] : turn === side })}>
				<div className={styles.icon}>
					<svg xmlns="http://www.w3.org/2000/svg" width="0.88em" height="1em" viewBox="0 0 448 512"><path fill="#b6b6b6" 
